...
- Latest tag: **`v0.1.215`** — **enum `.name`** (`Color.RED.name` → `"RED"`; with v0.1.213 `.value`). Recent: v0.1.214 `match` on enums, v0.1.213 Python `Enum` classes, v0.1.212 `match` `|`-patterns, v0.1.211 `match` statement, v0.1.210 dataclass `@property`. (v0.1.13 PTX gate.)
