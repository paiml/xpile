...
- Latest tag: **`v0.1.32`** — Python **set comprehensions** `{e for x in xs}` (completes list/dict/set comprehensions). Recent: v0.1.31 set `.add()`, v0.1.30 dict comprehensions, v0.1.29 sets, v0.1.28 general `if/else`. (v0.1.13 PTX gate.)
