...
- Latest tag: **`v0.1.219`** — **`frozenset(iterable)`** → `HashSet` (fixes a silent miscompile). Recent: v0.1.218 `str.split` maxsplit, v0.1.217 `str.replace` 3-arg, v0.1.216 `str.startswith`/`endswith` tuple, v0.1.215 enum `.name`, v0.1.214 `match` on enums. (v0.1.13 PTX gate.)
