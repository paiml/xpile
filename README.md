...
- Latest tag: **`v0.1.252`** — **`math.comb(n, k)`** (binomial coefficient). Recent: v0.1.251 `math.isqrt(n)`, v0.1.250 `math.factorial(n)`, v0.1.249 `math.lcm(a, b)`, v0.1.248 `math.gcd(a, b)`, v0.1.247 negative-step list slice `xs[::-k]`. (v0.1.13 PTX gate.)
