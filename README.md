...
- Latest tag: **`v0.1.67`** — Python **standalone `enumerate(xs)` / `zip(a, b)`** → lists of tuples. Recent: v0.1.66 `s.capitalize()`, v0.1.65 str predicates `.isdigit/.isalpha/.isspace`, v0.1.64 `str(float)`, v0.1.63 `str(bool)`. (v0.1.13 PTX gate.)
