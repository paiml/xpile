...
- Latest tag: **`v0.1.18`** — Python **`sep.join(xs)`** → `xs.join(sep)`, **completing the string-method family** (`upper/lower/strip/startswith/endswith/split/join` via `Expr::StrMethod`). (v0.1.14 WGSL gate; v0.1.13 PTX gate; v0.1.12 early returns.)
