...
- Latest tag: **`v0.1.80`** — Python **set element removal `s.remove(x)` / `s.discard(x)`**. Recent: v0.1.79 dict pop `d.pop(k)`, v0.1.78 item deletion `del coll[key]`, v0.1.77 list `xs.pop()`, v0.1.76 `xs.insert(i, x)`. (v0.1.13 PTX gate.)
