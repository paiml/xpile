...
- Latest tag: **`v0.1.99`** — Python **early returns / guard clauses + terminal `if/elif/else`**. Recent: v0.1.98 void functions (`-> None`), v0.1.97 `continue` / `break`, v0.1.96 module-level constants, v0.1.95 `s.index(sub)`. (v0.1.13 PTX gate.)
