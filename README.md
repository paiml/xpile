...
- Latest tag: **`v0.1.47`** — Python **substring containment** `sub in s` (`Expr::StrContains`). Recent: v0.1.46 `divmod(a, b)`, v0.1.45 numeric conversions `int(x)`/`float(x)`, v0.1.44 str methods `.lstrip/.rstrip/.find/.count`, v0.1.43 sequence repetition `"x"*n`. (v0.1.13 PTX gate.)
