...
- Latest tag: **`v0.1.79`** — Python **dict pop `d.pop(k)` / `d.pop(k, default)`** (expression form). Recent: v0.1.78 item deletion `del coll[key]`, v0.1.77 list `xs.pop()` / `xs.pop(i)`, v0.1.76 `xs.insert(i, x)`, v0.1.75 `xs.extend(ys)`. (v0.1.13 PTX gate.)
