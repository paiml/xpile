...
- Latest tag: **`v0.1.92`** — Python **`int(s)` / `float(s)` string parsing** (`s.trim().parse()`). Recent: v0.1.91 `bool(x)` truthiness cast, v0.1.90 multi-parameter + nullary closures, v0.1.89 first-class closures, v0.1.88 dict + set comprehensions over `range(...)`. (v0.1.13 PTX gate.)
