...
- Latest tag: **`v0.1.48`** — Python **chained comparisons** `a < b < c` → `(a<b) && (b<c)`. Recent: v0.1.47 substring containment `sub in s`, v0.1.46 `divmod(a, b)`, v0.1.45 numeric conversions `int(x)`/`float(x)`, v0.1.44 str methods `.lstrip/.rstrip/.find/.count`. (v0.1.13 PTX gate.)
