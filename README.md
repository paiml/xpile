...
- Latest tag: **`v0.1.157`** — **`f(*xs)` splat** into a variadic param. Recent: v0.1.156 nested functions (single-`return` → closure), v0.1.155 varargs `*args` (→ `list[elem]` param), v0.1.154 printf `%x`/`%X`/`%o` (sign-first radix), v0.1.153 `%s` over bool/float, v0.1.152 printf `%`-format width/precision. (v0.1.13 PTX gate.)
