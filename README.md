...
- Latest tag: **`v0.1.40`** — Python **`min/max` over a `list[float]`** (`Expr::ListMinMax.of_float`, fold-based). Recent: v0.1.39 set algebra `a|b a&b a-b a^b`, v0.1.38 `sorted(reverse=True)`, v0.1.37 `raise Exc("msg")` → `panic!`, v0.1.36 `min/max(xs)`. (v0.1.13 PTX gate.)
