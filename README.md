...
- Latest tag: **`v0.1.64`** — Python **`str(float)`** (Python-matching, e.g. `2.0`→`"2.0"`) — completes `str()` for int/float/bool. Recent: v0.1.63 `str(bool)`, v0.1.62 `str(int)`, v0.1.61 `map(lambda, xs)`, v0.1.60 `filter(lambda, xs)`. (v0.1.13 PTX gate.)
