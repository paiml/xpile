...
- Latest tag: **`v0.1.86`** — Python **in-place dict merge `a.update(b)`**. Recent: v0.1.85 list comprehension over `range(...)`, v0.1.84 filtered dict + set comprehensions, v0.1.83 filtered list comprehension, v0.1.82 dict get-or-insert `d.setdefault(k, default)`. (v0.1.13 PTX gate.)
