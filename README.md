...
- Latest tag: **`v0.1.36`** — Python 1-arg **`min(xs)`/`max(xs)`** over a list (`Expr::ListMinMax`). Recent: v0.1.35 `reversed(xs)`, v0.1.34 `sorted(xs)`, v0.1.33 `str.replace`, v0.1.32 set comprehensions. (v0.1.13 PTX gate.)
