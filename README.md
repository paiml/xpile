...
- Latest tag: **`v0.1.213`** — **Python `Enum` classes** → Rust enums (`class C(Enum): RED = 1`; `C.RED` → `C::RED`, `C.RED.value` → discriminant). Recent: v0.1.212 `match` `|`-patterns, v0.1.211 `match` statement, v0.1.210 dataclass `@property`, v0.1.209 augmented struct field assignment, v0.1.208 dataclass `@classmethod`. (v0.1.13 PTX gate.)
