...
- **100% QUORUM, 100% Silver, 100% Gold, AND 100% Platinum** — every contract has paired Lean refinement theorem + Kani BMC harness ([`xpile quorum`](crates/xpile/src/quorum.rs)); **224 Lean theorems (53 Bronze + 108 Silver + 24 Gold + 39 Platinum) + 43 Kani harnesses = 267 stratum-vote artifacts** post-PMAT-156..212. 42/42 equations at Silver; **12/12 contracts at Gold** (5 subtype patterns); **12/12 contracts at Platinum** demonstrating 7 distinct compositional algebraic shapes (commutativity, associativity/distributivity, idempotence, functoriality, transitivity, additivity, input-determinism)
...
**224 Lean refinement theorems** ([`contracts/lean/*.lean`](contracts/lean/), 53 Bronze + 108 Silver + 24 Gold + 39 Platinum) +
**43 Kani BMC harnesses** ([`contracts/kani/*.rs`](contracts/kani/)) —
**267 stratum-vote artifacts** across all 5 layers of the contract taxonomy. **42/42 equations at Silver tier** (PMAT-183) + **12/12 contracts at Gold tier** (PMAT-185..197) + **12/12 contracts at Platinum tier** (PMAT-199..212) demonstrating 7 distinct compositional algebraic shapes.
