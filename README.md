...
- Latest tag: **`v0.1.195`** — **R6: grandfather the Diamond depth-13 gate** (new contracts join at depth-1+ without the treadmill; unblocks the two missing contract YAMLs). Recent: v0.1.194 two-generator dict & set comprehensions, v0.1.193 two-generator list comprehension, v0.1.192 bitwise invert `~x`, v0.1.191 Optional intra-branch narrowing, v0.1.190 Optional flow-narrowing (cut 4 keystone). (v0.1.13 PTX gate.)
