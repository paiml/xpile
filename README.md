...
- Latest tag: **`v0.1.73`** — Python **assert with message** `assert cond, msg` → `assert!(cond, "{}", msg)`. Recent: v0.1.72 list membership `x in xs`, v0.1.71 f-string format specs, v0.1.70 `round(x, n)`, v0.1.69 `round(x)`. (v0.1.13 PTX gate.)
