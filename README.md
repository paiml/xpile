...
- Latest tag: **`v0.1.21`** — Python **bounded slicing** `xs[a:b]` (list → `Vec` / str → `String`, `Expr::Slice`). Recent: v0.1.20 tuple unpacking (tuple lane complete), v0.1.18 string-method family. (v0.1.14 WGSL gate; v0.1.13 PTX gate.)
