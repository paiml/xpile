...
- Latest tag: **`v0.1.223`** — **negative-step `range`** (`list(range(n, 0, -1))` → descending Vec). Recent: v0.1.222 `len`/`sorted`/`reversed`(range) + `list(dict)`, v0.1.221 `sum`/`max`/`min` over range/set, v0.1.220 `list(set)`/`sorted(set)`, v0.1.219 `frozenset`, v0.1.218 `str.split` maxsplit. (v0.1.13 PTX gate.)
