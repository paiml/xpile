...
- Latest tag: **`v0.1.38`** — Python **`sorted(xs, reverse=True)`** (descending; `Expr::Sorted.reverse`). Recent: v0.1.37 `raise Exc("msg")` → `panic!`, v0.1.36 `min/max(xs)`, v0.1.35 `reversed(xs)`, v0.1.34 `sorted(xs)`. (v0.1.13 PTX gate.)
