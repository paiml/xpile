...
- Latest tag: **`v0.1.19`** — Python **tuples** (first cut): multiple-return + `tuple[T0,T1]` annotations → meta-HIR `Type::Tuple`/`Expr::TupleLit` → Rust `(e0, e1)` (unpacking is a follow-up). v0.1.18 completed the **string-method family** (`upper/lower/strip/startswith/endswith/split/join`). (v0.1.14 WGSL gate; v0.1.13 PTX gate.)
