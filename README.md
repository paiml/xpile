...
- Latest tag: **`v0.1.149`** — **`dict(pairs)`** (also `dict(zip(..))`/`dict(enumerate(..))`). Recent: v0.1.148 `str.partition`/`.rpartition`, v0.1.147 `str.isupper`/`.islower`/`.isalnum` predicates, v0.1.146 `min`/`max(xs, default=)`, v0.1.145 filtered generator expressions, v0.1.144 generator expressions. (v0.1.13 PTX gate.)
