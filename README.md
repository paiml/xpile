...
- Latest tag: **`v0.1.244`** — **`str.rfind` / `str.rindex`** (reverse substring search). Recent: v0.1.243 `enumerate()`/`zip()` over a string, v0.1.242 two-generator comprehensions over `range`, v0.1.241 mixed `float`/`int` ternary, v0.1.240 mixed-numeric `min()`/`max()`, v0.1.239 mixed `float`/`int` compare + arithmetic. (v0.1.13 PTX gate.)
