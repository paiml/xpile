...
- Latest tag: **`v0.1.54`** — Python **dict views** `d.keys()` / `d.values()`. Recent: v0.1.53 list query `xs.count/.index`, v0.1.52 reverse-slice `xs[::-1]`, v0.1.51 negative list indexing `xs[-1]`, v0.1.50 open-ended slices. (v0.1.13 PTX gate.)
