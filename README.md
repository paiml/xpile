...
- Latest tag: **`v0.1.20`** — Python **tuple unpacking** `a, b = f()` (`Stmt::LetTuple` → Rust `let (a, b) = …`), completing the tuple lane (literals + `tuple[...]` + multiple-return + unpacking). v0.1.18 completed the **string-method family**. (v0.1.14 WGSL gate; v0.1.13 PTX gate.)
