...
- Latest tag: **`v0.1.102`** — Python **float-variable negation** (`-x`, `x: float`). Recent: v0.1.101 negative float literals (`-3.14`), v0.1.100 `pass`, v0.1.99 early returns / guard clauses + terminal `if/elif/else`, v0.1.98 void functions (`-> None`), v0.1.97 `continue` / `break`. (v0.1.13 PTX gate.)
