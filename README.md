...
- Latest tag: **`v0.1.77`** — Python **list `xs.pop()` / `xs.pop(i)`** (expression form, returns the removed element). Recent: v0.1.76 `xs.insert(i, x)`, v0.1.75 `xs.extend(ys)`, v0.1.74 in-place list mutators `xs.sort()`/`.reverse()`/`.clear()`, v0.1.73 assert with message. (v0.1.13 PTX gate.)
