...
- Latest tag: **`v0.1.111`** — **`print(sep=…, end=…)`** kwargs. Recent: v0.1.110 print of bool/float (`True`/`3.0`), v0.1.109 the `print` builtin (→ `println!`), v0.1.108 bare `return` (guard clauses), v0.1.107 float aug-assign with int rhs, v0.1.106 float power. Print supports int/str/bool/float + sep/end, byte-identical to CPython. (v0.1.13 PTX gate.)
