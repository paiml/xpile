...
- Latest tag: **`v0.1.37`** — Python **`raise Exc("msg")`** guard clauses → `panic!` (`Stmt::Raise`, exceptions sub-slice 1). Recent: v0.1.36 `min/max(xs)`, v0.1.35 `reversed(xs)`, v0.1.34 `sorted(xs)`, v0.1.33 `str.replace`. (v0.1.13 PTX gate.)
