...
- Latest tag: **`v0.1.153`** — **`%s` over bool/float** (Python repr). Recent: v0.1.152 printf `%`-format width/precision (`%.2f`, `%5d`), v0.1.151 printf-style `"%d" % n`, v0.1.150 `str.splitlines()` (full Python boundary set), v0.1.149 `dict(pairs)`, v0.1.148 `str.partition`/`.rpartition`. (v0.1.13 PTX gate.)
