...
- Latest tag: **`v0.1.39`** — Python **set algebra** `a|b` `a&b` `a-b` `a^b` (`Expr::SetOp`). Recent: v0.1.38 `sorted(reverse=True)`, v0.1.37 `raise Exc("msg")` → `panic!`, v0.1.36 `min/max(xs)`, v0.1.35 `reversed(xs)`. (v0.1.13 PTX gate.)
