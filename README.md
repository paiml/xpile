...
- Latest tag: **`v0.1.33`** — Python **`str.replace(old, new)`** → `.replace(&(old)[..], &(new)[..])` (`StrMethodOp::Replace`). Recent: v0.1.32 set comprehensions, v0.1.31 set `.add()`, v0.1.30 dict comprehensions, v0.1.29 sets. (v0.1.13 PTX gate.)
