...
- Latest tag: **`v0.1.76`** — Python **list `xs.insert(i, x)`** (positional insertion). Recent: v0.1.75 `xs.extend(ys)`, v0.1.74 in-place list mutators `xs.sort()`/`.reverse()`/`.clear()`, v0.1.73 assert with message, v0.1.72 list membership `x in xs`. (v0.1.13 PTX gate.)
