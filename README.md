...
- Latest tag: **`v0.1.58`** — Python **`sorted(xs, key=lambda p: e)`** → `sort_by_key` (first lambda/closure support). Recent: v0.1.57 `for k,v in d.items()`, v0.1.56 `d.items()`, v0.1.55 context-aware `len(x)`, v0.1.54 dict views. (v0.1.13 PTX gate.)
