...
- Latest tag: **`v0.1.66`** — Python **`s.capitalize()`** (first char upper, rest lower). Recent: v0.1.65 str predicates `.isdigit/.isalpha/.isspace`, v0.1.64 `str(float)`, v0.1.63 `str(bool)`, v0.1.62 `str(int)`. (v0.1.13 PTX gate.)
