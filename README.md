...
- Latest tag: **`v0.1.24`** — §29 structured **`compile_targets.via_roles`** in the PTX contract + in-tree validator (one general emitter, no specialist-only route, `DiffExec` tolerance). Recent: v0.1.23 enumerate/zip, v0.1.22 DiffExecEngine hook, v0.1.21 slicing, v0.1.20 tuples. (v0.1.13 PTX gate.)
