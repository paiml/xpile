...
- Latest tag: **`v0.1.205`** — **dataclass keyword construction** (`Point(x=1, y=2)`, mixed, reordered → fields in declaration order). Recent: v0.1.204 dataclass methods, v0.1.203 dataclass field assignment, v0.1.202 dataclass construction + field access (`Type::Struct`), v0.1.201 `@dataclass` → struct definition, v0.1.200 statement-position assignment-form `try`/`except`. (v0.1.13 PTX gate.)
