...
- Latest tag: **`v0.1.63`** — Python **`str(b)`** (bool → `"True"`/`"False"`, capitalized). Recent: v0.1.62 `str(int)`, v0.1.61 `map(lambda, xs)`, v0.1.60 `filter(lambda, xs)`, v0.1.59 `min/max(key=lambda)`, v0.1.58 `sorted(key=lambda)`. (v0.1.13 PTX gate.)
