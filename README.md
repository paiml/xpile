...
- Latest tag: **`v0.1.71`** — Python **f-string format specs** `f"{x:.2f}"` `f"{n:05d}"` `f"{s:>8}"`. Recent: v0.1.70 `round(x, n)`, v0.1.69 `round(x)`, v0.1.68 `s.title()`, v0.1.67 standalone `enumerate`/`zip`. (v0.1.13 PTX gate.)
