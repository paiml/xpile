...
- Latest tag: **`v0.1.250`** — **`math.factorial(n)`**. Recent: v0.1.249 `math.lcm(a, b)`, v0.1.248 `math.gcd(a, b)`, v0.1.247 negative-step list slice `xs[::-k]`, v0.1.246 tuple-unpack init + augment, v0.1.245 comprehensions/genexprs over a string. (v0.1.13 PTX gate.)
