...
- Latest tag: **`v0.1.49`** — Python **tuple indexing** `t[0]` → `t.0` (`Expr::TupleIndex`). Recent: v0.1.48 chained comparisons `a < b < c`, v0.1.47 substring containment `sub in s`, v0.1.46 `divmod(a, b)`, v0.1.45 numeric conversions `int(x)`/`float(x)`. (v0.1.13 PTX gate.)
