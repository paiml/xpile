...
- Latest tag: **`v0.1.57`** — Python **`for k, v in d.items()`** loop (`PairIterKind::Pairs`). Recent: v0.1.56 `d.items()`, v0.1.55 context-aware `len(x)`, v0.1.54 dict views `d.keys()/.values()`, v0.1.53 list query `xs.count/.index`. (v0.1.13 PTX gate.)
