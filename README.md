...
- Latest tag: **`v0.1.31`** — Python set **`.add()`** mutation → `s.insert(x)` (`Stmt::SetAdd`; pre-pass marks the binding `mut`). Recent: v0.1.30 dict comprehensions, v0.1.29 sets, v0.1.28 general `if/else`, v0.1.27 `sum`. (v0.1.13 PTX gate.)
