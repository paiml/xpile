...
- Latest tag: **`v0.1.118`** — **dict comprehension over `d.items()`** (`{k: f(v) for k, v in d.items()}`). Recent: v0.1.117 context-aware `and`/`or` over bool vars, v0.1.116 string indexing (`s[0]`, `s[-1]`, `s[i]`), v0.1.115 context-aware `not <bool var>`, v0.1.114 `str.format` positional `{0}`/`{1}`, v0.1.113 `enumerate(xs, start)`. (v0.1.13 PTX gate.)
