...
- Latest tag: **`v0.1.212`** — **`match` `|`-patterns** (`case 0 | 1 | 2:` → OR of equality tests). Recent: v0.1.211 `match` statement (literal dispatch), v0.1.210 dataclass `@property`, v0.1.209 augmented struct field assignment, v0.1.208 dataclass `@classmethod`, v0.1.207 dataclass `@staticmethod`. (v0.1.13 PTX gate.)
