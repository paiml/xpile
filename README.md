...
- Latest tag: **`v0.1.154`** — printf **`%x`/`%X`/`%o`** (sign-first radix). Recent: v0.1.153 `%s` over bool/float, v0.1.152 printf `%`-format width/precision, v0.1.151 printf-style `"%d" % n`, v0.1.150 `str.splitlines()` (full Python boundary set), v0.1.149 `dict(pairs)`. (v0.1.13 PTX gate.)
