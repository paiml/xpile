...
- Latest tag: **`v0.1.142`** — context-aware **collection literals** (builtins in `[abs(a), abs(b)]`). Recent: v0.1.141 context-aware comparison operands, v0.1.140 context-aware ternary branches, v0.1.139 `int(s, base)` radix parsing, v0.1.138 variadic `min`/`max` (`max(a, b, c)`), v0.1.137 `pow(a, b)` builtin. (v0.1.13 PTX gate.)
