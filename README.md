...
- Latest tag: **`v0.1.87`** — Python **general slice step `xs[a:b:c]`** (positive step over a list). Recent: v0.1.86 in-place dict merge `a.update(b)`, v0.1.85 list comprehension over `range(...)`, v0.1.84 filtered dict + set comprehensions, v0.1.83 filtered list comprehension. (v0.1.13 PTX gate.)
