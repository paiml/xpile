...
- Latest tag: **`v0.1.43`** — Python **sequence repetition** `"x"*n` / `[0]*n` (`Expr::Repeat`). Recent: v0.1.42 `all/any` over `list[bool]`, v0.1.41 empty constructors `set()/dict()/list()`, v0.1.40 `min/max` over `list[float]`, v0.1.39 set algebra. (v0.1.13 PTX gate.)
