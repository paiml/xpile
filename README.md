...
- Latest tag: **`v0.1.74`** — Python **in-place list mutators** `xs.sort()`/`xs.reverse()`/`xs.clear()`. Recent: v0.1.73 assert with message, v0.1.72 list membership `x in xs`, v0.1.71 f-string format specs, v0.1.70 `round(x, n)`. (v0.1.13 PTX gate.)
