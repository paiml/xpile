...
- Latest tag: **`v0.1.35`** — Python **`reversed(xs)`** → a new reversed list (`Expr::Reversed`). Recent: v0.1.34 `sorted(xs)`, v0.1.33 `str.replace`, v0.1.32 set comprehensions, v0.1.31 set `.add()`. (v0.1.13 PTX gate.)
