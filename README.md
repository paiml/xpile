...
- Latest tag: **`v0.1.34`** — Python **`sorted(xs)`** → a new sorted list (`Expr::Sorted`). Recent: v0.1.33 `str.replace`, v0.1.32 set comprehensions, v0.1.31 set `.add()`, v0.1.30 dict comprehensions. (v0.1.13 PTX gate.)
