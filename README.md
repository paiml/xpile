...
- Latest tag: **`v0.1.214`** — **`match` on enums** (`case Color.RED:` / `case Color.RED | Color.BLUE:` → enum-member equality). Recent: v0.1.213 Python `Enum` classes, v0.1.212 `match` `|`-patterns, v0.1.211 `match` statement, v0.1.210 dataclass `@property`, v0.1.209 augmented struct field assignment. (v0.1.13 PTX gate.)
