...
- Latest tag: **`v0.1.27`** — Python **`sum(xs)`** over numeric lists → `xs.iter().sum::<i64>()` / `::<f64>()` (`Expr::Sum`). Recent: v0.1.26 abs/min/max, v0.1.25 aug-subscript-assign, v0.1.24 structured `via_roles`, v0.1.23 enumerate/zip. (v0.1.13 PTX gate.)
