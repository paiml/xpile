...
- Latest tag: **`v0.1.68`** — Python **`s.title()`** (title-case each word, Python-exact). Recent: v0.1.67 standalone `enumerate`/`zip`, v0.1.66 `s.capitalize()`, v0.1.65 str predicates `.isdigit/.isalpha/.isspace`, v0.1.64 `str(float)`. (v0.1.13 PTX gate.)
