...
- Latest tag: **`v0.1.50`** — Python **open-ended slices** `xs[a:]` / `xs[:b]` / `xs[:]` (list + str). Recent: v0.1.49 tuple indexing `t[0]`, v0.1.48 chained comparisons `a < b < c`, v0.1.47 substring containment `sub in s`, v0.1.46 `divmod(a, b)`. (v0.1.13 PTX gate.)
