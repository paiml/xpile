...
- Latest tag: **`v0.1.241`** — **correctness: mixed `float`/`int` ternary** (`x if b else 0` over a float now compiles). Recent: v0.1.240 mixed-numeric `min()`/`max()`, v0.1.239 mixed `float`/`int` compare + arithmetic, v0.1.238 negative/OOB slice bounds, v0.1.237 `//`/`%` with a negative divisor, v0.1.236 keyword form of `str.format`. (v0.1.13 PTX gate.)
