...
- Latest tag: **`v0.1.112`** — **chained assignment** (`x = y = z = 0`). Recent: v0.1.111 `print(sep=…, end=…)` kwargs, v0.1.110 print of bool/float, v0.1.109 the `print` builtin (→ `println!`), v0.1.108 bare `return` (guard clauses), v0.1.107 float aug-assign with int rhs. (v0.1.13 PTX gate.)
