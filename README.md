...
- Latest tag: **`v0.1.78`** — Python **item deletion `del coll[key]`** (list `.remove(i)` / dict `.remove(&k)`). Recent: v0.1.77 list `xs.pop()` / `xs.pop(i)`, v0.1.76 `xs.insert(i, x)`, v0.1.75 `xs.extend(ys)`, v0.1.74 in-place list mutators. (v0.1.13 PTX gate.)
