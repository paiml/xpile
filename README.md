...
- Latest tag: **`v0.1.148`** — **`str.partition`/`.rpartition`** (3-tuple split). Recent: v0.1.147 `str.isupper`/`.islower`/`.isalnum` predicates, v0.1.146 `min`/`max(xs, default=)`, v0.1.145 filtered generator expressions, v0.1.144 generator expressions, v0.1.143 context-aware subscript index + unary `-`. (v0.1.13 PTX gate.)
