...
- Latest tag: **`v0.1.228`** — **bare `xs.pop()` statement** (`while xs: xs.pop()`). Recent: v0.1.227 container truthiness, v0.1.226 `map`/`filter` typed lambda, v0.1.225 comprehension/genexpr typed elements, v0.1.224 `sorted`/`min`/`max` tuple key, v0.1.223 negative-step `range`. (v0.1.13 PTX gate.)
