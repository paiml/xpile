...
- Latest tag: **`v0.1.208`** — **dataclass `@classmethod`** (`cls(...)` constructs the class; `Class.method(args)` → `Class::method(args)`) — completes the method-decorator trio (static/class/instance). Recent: v0.1.207 dataclass `@staticmethod`, v0.1.206 dataclass field defaults, v0.1.205 dataclass keyword construction, v0.1.204 dataclass methods, v0.1.203 dataclass field assignment. (v0.1.13 PTX gate.)
