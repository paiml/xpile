...
- Latest tag: **`v0.1.91`** — Python **`bool(x)` truthiness cast** (`x != 0` / `len(x) != 0`). Recent: v0.1.90 multi-parameter + nullary closures, v0.1.89 first-class closures, v0.1.88 dict + set comprehensions over `range(...)`, v0.1.87 general slice step `xs[a:b:c]`. (v0.1.13 PTX gate.)
