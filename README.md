...
- Latest tag: **`v0.1.17`** — Python **`str.split(sep)`** → `Vec<String>` (`list[str]`), extending `Expr::StrMethod` (`.upper/.lower/.strip` + `.startswith/.endswith` predicates). Only `join` remains of the string-method family. (v0.1.14 WGSL gate; v0.1.13 PTX gate; v0.1.12 early returns.)
