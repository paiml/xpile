...
- Latest tag: **`v0.1.107`** — float **augmented assignment with int rhs** (`x += 1`, `x **= 2`). Recent: v0.1.106 float power (`x ** 2`), v0.1.105 true division (`/` → float), v0.1.104 float floor-division / modulo (`//`, `%`), v0.1.103 float augmented assignment (`x += y`), v0.1.102 float-variable negation. Float arithmetic family complete. (v0.1.13 PTX gate.)
