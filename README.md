...
- Latest tag: **`v0.1.41`** — Python **empty constructors** `set()` `dict()` `list()`. Recent: v0.1.40 `min/max` over `list[float]`, v0.1.39 set algebra `a|b a&b a-b a^b`, v0.1.38 `sorted(reverse=True)`, v0.1.37 `raise Exc("msg")` → `panic!`. (v0.1.13 PTX gate.)
